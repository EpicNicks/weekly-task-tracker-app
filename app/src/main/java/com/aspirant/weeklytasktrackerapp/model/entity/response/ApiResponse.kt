...
//        Log.i("ApiResponse deserialize", jsonObject.toString())
//        return when {
...
//                        val taskListType = object : TypeToken<List<Any>>() {}.type
//                        context?.deserialize<List<Any>>(valueJsonElement, taskListType)
//                    } else {
...
//
//            else -> {
//                ApiResponse.failure("Unknown error $jsonObject")
//            }
//        }
//    }
//}
